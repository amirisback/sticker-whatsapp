...
package com.frogobox.stickerwa.util;
...
import com.frogobox.stickerwa.model.Sticker;
import com.frogobox.stickerwa.model.StickerPack;
import com.frogobox.stickerwa.provider.StickerContentProvider;
...
import static com.frogobox.stickerwa.provider.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.frogobox.stickerwa.provider.StickerContentProvider.AVOID_CACHE;
import static com.frogobox.stickerwa.provider.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.frogobox.stickerwa.provider.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static com.frogobox.stickerwa.provider.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static com.frogobox.stickerwa.provider.StickerContentProvider.PUBLISHER_EMAIL;
import static com.frogobox.stickerwa.provider.StickerContentProvider.PUBLISHER_WEBSITE;
import static com.frogobox.stickerwa.provider.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static com.frogobox.stickerwa.provider.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static com.frogobox.stickerwa.provider.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static com.frogobox.stickerwa.provider.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static com.frogobox.stickerwa.provider.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static com.frogobox.stickerwa.provider.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
import static com.frogobox.stickerwa.provider.StickerContentProvider.IMAGE_DATA_VERSION;
