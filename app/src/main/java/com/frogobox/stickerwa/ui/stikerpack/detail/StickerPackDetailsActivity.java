...
import com.frogobox.stickerwa.databinding.ActivityStickerPackDetailsBinding;
import com.frogobox.stickerwa.model.StickerPack;
import com.frogobox.stickerwa.ui.addstiker.AddStickerPackActivity;
import com.frogobox.stickerwa.ui.stikerpack.info.StickerPackInfoActivity;
import com.frogobox.stickerwa.util.StickerPackLoader;
import com.frogobox.stickerwa.util.WhitelistCheck;
...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityStickerPackDetailsBinding.inflate(LayoutInflater.from(this));
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener pageLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            setNumColumns(binding.stickerList.getWidth() / binding.stickerList.getContext().getResources().getDimensionPixelSize(R.dimen.sticker_pack_details_image_size));
        }
    };
